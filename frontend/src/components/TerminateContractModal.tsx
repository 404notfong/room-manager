...
export default function TerminateContractModal({
    ...
    const handleSubmit = () => {
        ...
        if (createFinalInvoice && contract.contractType === 'LONG_TERM') {
            // Open CreateInvoiceModal in FINAL mode
    ...
    const handleFinalInvoiceSuccess = () => {
        // After FINAL invoice is created, terminate the contract
        setShowFinalInvoiceModal(false);
        terminateMutation.mutate({
            endDate: new Date(endDate),
            createFinalInvoice: false, // Invoice already created
        });
    };
    ...
    return (
        <>
            <Dialog open={open && !showFinalInvoiceModal} onOpenChange={onOpenChange}>
                <DialogContent className="max-w-lg">
                    ...
                    <DialogFooter className="gap-2">
                        ...
                        >
                            ...
                            ) : createFinalInvoice && contractType === 'LONG_TERM' ? (
                                <>
