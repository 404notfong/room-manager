...
> Thêm các yêu cầu thay đổi vào file này, sau đó chạy lệnh `/do-changes` để thực thi.
> Thêm các rule này vào guideline dự án để các module sau tuân theo
...
- [x] Thêm validation email, mật khẩu lúc login, register
